...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public SecurityConfig(TokenProvider tokenProvider, CustomAccessDeniedHandler customAccessDeniedHandler, CustomAuthenticationEntryPoint customAuthenticationEntryPoint) {
